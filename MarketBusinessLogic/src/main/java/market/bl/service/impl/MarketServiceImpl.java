...
import market.bl.service.IMarketService;
...
public class MarketService implements IMarketService {
    ...
    @Override
    public void createOrder(PurchaseOrder order) throws MarketException {
...
//        }
    ...
    public PurchaseOrder getPurchaseOrder(int id) {
        return dao.get(id, PurchaseOrder.class);
    }

    @Override
    public void modifyOrder(PurchaseOrder order) throws MarketException {
        PurchaseOrder oldOrder = getPurchaseOrder(order.id);
...
//        PurchaseOrder order = dao.get(task.orderId, PurchaseOrder.class);
//
...
//    }
//
//    public void handleRequestPriceList(PurchaseOrder order, UserOrder userOrder, Task task) throws MarketException {
